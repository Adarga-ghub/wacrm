...
/** 100 MB — matches the `file_size_limit` on both buckets (migrations 016/020/023/058). */
 ...
 * and the send fails with a confusing 400. Images are Meta's tightest
 * cap at 5 MB; video/audio are capped at Meta's 16 MB ceiling; documents
 * are held at Meta's 100 MB document cap (migration 058 raised the
 * bucket limit to match).
 */
